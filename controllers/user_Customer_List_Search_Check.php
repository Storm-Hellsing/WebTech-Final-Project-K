...
<html>
    ...
    <body>
        <div class="main-block">
            ...
            <form method="GET" action="../controllers/user_Customer_List_Search_Check.php" enctype="">
            ...
            <?php
                ...
                $sql = "SELECT * FROM `user_all` WHERE (`user_name` LIKE '%{$searchResult}%' OR `user_email` LIKE '%{$searchResult}%' OR `user_mobile` LIKE '%{$searchResult}') AND `user_type` = 'Customer' ORDER BY user_name ASC";
            ...
            <tr>
                ...
                <?php
                    ...
                    $sql = "SELECT `user_id`, `user_type`, `user_name`, `user_email`, `user_mobile`, `user_businessname`, `user_businesslink`, `joining_date`, `joining_time` 
                            FROM `user_all`
                            WHERE (`user_name` LIKE '%{$searchResult}%' OR `user_email` LIKE '%{$searchResult}%' OR `user_mobile` LIKE '%{$searchResult}') AND `user_type` = 'Customer' 
